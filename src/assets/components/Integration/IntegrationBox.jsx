        ...
        <div className="col-span-1">
          ...
          >
            ...
            >
              ...
              <div className="relative justify-center transition-all duration-200 ease-linear bg-base flex w-full cursor-pointer flex-col items-center gap-3 rounded-xl p-8 hover:border-gray/40 transform-3d">
